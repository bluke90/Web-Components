...
class SiteModal extends HTMLElement {
  ...
  constructor() {
    ...
    const template = document.getElementById('site-modal').content.cloneNode(true);
...
// document.body.innerHTML += "<site-modal><h3 slot=\"title\">Form Submitted</h3><p slot=\"body\">Your form has been submitted.</p></site-modal>";
